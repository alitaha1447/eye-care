          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-5">
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <div className="text-xs font-bold text-[#082852]">Address</div>
                  <div className="mt-1 text-xs leading-relaxed text-slate-600 font-medium">
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <div className="text-xs font-bold text-[#082852]">Phone</div>
                  <a
                    href="tel:+919010888066"
                    className="mt-1 block text-xs font-semibold text-slate-700 hover:text-clinic-green"
                  >
                    +91 90108 88066
                  </a>
                </div>
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <div className="text-xs font-bold text-[#082852]">Email</div>
                  <a
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <div className="text-xs font-bold text-[#082852]">Working Hours</div>
                  <div className="mt-1 text-xs leading-relaxed text-slate-600 font-medium">
          ...
          <div className="rounded-xl border border-slate-200/80 bg-white p-5 shadow-xs sm:p-6">
            ...
            {submitted ? (
              <div className="my-8 rounded-lg bg-clinic-mint p-5 text-center">
                ...
                <h4 className="text-sm font-bold text-[#082852]">Message Sent!</h4>
              ...
              <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-3">
                ...
                <div>
                  <textarea
                    ...
                    required
                    className="w-full resize-none rounded-md border border-slate-200 bg-white px-3.5 py-2.5 text-xs text-slate-800 placeholder:text-slate-400 focus:border-clinic-green focus:outline-none focus:ring-1 focus:ring-clinic-green"
                  />
                </div>

                <button
                  type="submit"
                  className="mt-1 w-full rounded-md bg-clinic-green py-2.5 text-xs font-bold text-white transition-colors duration-150 hover:bg-clinic-green-dark shadow-sm"
                >
                  Send Message
                </button>
              </form>
